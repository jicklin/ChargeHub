        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text(
                        "使用 InfiniCLOUD 的 WebDAV 作为同步载体，会在远端保存 devices.json、life-reminders.json、trips.json、reference-photos.json 和 reference-images/ 图片文件夹。建议地址使用专门目录，例如 https://你的账号.infini-cloud.net/dav/ChargeHub/；密码请使用 InfiniCLOUD 提供的应用密码或 WebDAV 密码。"
                    )
                }
