    ...
    class WeChatBypassLauncher: NSObject, WKNavigationDelegate {
        ...
        func startBypass(url: URL) {
            ...
            let webView = WKWebView(
                frame: CGRect(x: 0, y: 100, width: 100, height: 100), configuration: config)
            ...
            webView.customUserAgent =
                "\(baseUA) MicroMessenger/8.0.50(0x1800322c) NetType/WIFI Language/zh_CN"
            ...
            if let url = navigationAction.request.url {
                ...
                if url.scheme == "weixin" {
                    ...
                    if UIApplication.shared.canOpenURL(url) {
                        ...
                        print(
                            "❌ 【WeChatBypass】系统提示无法打开 weixin://，请检查 Info.plist 的 LSApplicationQueriesSchemes 是否配置了 weixin"
                        )
                    }
        ...
        func webView(
            ...
            print(
                "❌ 【WeChatBypass】页面加载发生临时错误 (Provisional): \(error.localizedDescription), 错误详情: \(error)"
            )
        }
